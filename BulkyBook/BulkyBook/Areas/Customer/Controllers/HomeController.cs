...
namespace BulkyBook.Areas.Customer.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Details(int id) // http get 
        {
        ...
        [Authorize]
        public IActionResult Details(ShoppingCart CartObject) // http get 
        {
            CartObject.Id = 0;
            if (ModelState.IsValid)
            {
                ...
                if(CartFromDb == null)
                {
                    // no record exists in database for that product for that user we have to add this cart 
